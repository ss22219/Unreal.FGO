define(function(require, exports, module) {
	...
	var $ = require("jquery");
	/*
	 * ! jQuery UI - v1.11.4 - 2015-04-15 http://jqueryui.com Includes: core.js,
	 * widget.js, position.js, autocomplete.js, menu.js Copyright 2015 jQuery
	...
	(function(factory) {
		if (typeof define === "function" && define.amd) {
			...
			(function($) {
				 ...
				 * 
				 * Copyright jQuery Foundation and other contributors Released
				...
				function focusable(element, isTabIndexNotNaN) {
					...
					return (/^(input|select|textarea|button|object)$/
							...
							&&
							// the element and all of its ancestors must be
							// visible
							visible(element);
				}
					...
					$
							.each(
									...
									function(i, name) {
										...
										function reduce(elem, size, border,
												margin) {
											$
													.each(
															side,
				...
				// deprecated
				$.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent
						.toLowerCase());
				...
				$.widget = function(name, base, prototype) {
					...
					// extend with the existing constructor to carry over any
					// static properties
					$.extend(constructor, existingConstructor, {
						version : prototype.version,
						// copy the object used to create the prototype in case
						// we need to
						// redefine the widget later
						_proto : $.extend({}, prototype),
						// track widgets that inherit from this widget in case
						// this widget is
					...
					// we need to make the options hash a property directly on
					// the new instance
					// otherwise we'll modify the options hash on the prototype
					// that we're
					// inheriting from
					...
					// If this widget is being redefined then we need to find
					// all widgets that
					// are inheriting from it and redefine all of them so that
					// they inherit from
					// the new version of this widget. We're essentially trying
					// to replace one
					...
					if (existingConstructor) {
						...
						// remove the list of existing child constructors from
						// the old constructor
				...
				$.Widget.prototype = {
					...
					_setOption : function(key, value) {
						...
						if (key === "disabled") {
							...
							// If the widget is becoming disabled, then nothing
							// is interactive
							if (value) {
								this.hoverable.removeClass("ui-state-hover");
								this.focusable.removeClass("ui-state-focus");
				...
				(function() {
					...
					$.position = {
						...
						getWithinInfo : function(element) {
							...
							return {
								...
								// jQuery 1.6 doesn't support
								// .outerWidth/Height() on documents or windows
					...
					$.fn.position = function(options) {
						...
						// positions
						// if a value is missing or invalid, it will be
						// converted to center
						$
								.each(
										[ "my", "at" ],
										function() {
											...
											// calculate offsets
											horizontalOffset = roffset
													.exec(pos[0]);
											verticalOffset = roffset
													.exec(pos[1]);
											offsets[this] = [
						...
						atOffset = getOffsets(offsets.at, targetWidth,
								targetHeight);
						...
						fit : {
							left : function(position, data) {
								...
								if (data.collisionWidth > outerWidth) {
									// element is initially over the left side
									// of within
									if (overLeft > 0 && overRight <= 0) {
										...
										position.left += overLeft
												- newOverRight;
										// element is initially over right side
										// of within
									} else if (overRight > 0 && overLeft <= 0) {
										position.left = withinOffset;
										// element is initially over both left
										// and right sides of within
									} else {
							...
							top : function(position, data) {
								...
								if (data.collisionHeight > outerHeight) {
									// element is initially over the top of
									// within
					...
					(function() {
						...
						// Create a "fake body" for testing based on method used
						// in jQuery.support
						...
						.widget(
								"ui.menu",
								{
									...
									_create : function() {
										...
										// Flag used to prevent firing of the
										// click handler
										// as the event bubbles up through
										// nested menus
										...
										this
												._on({
													...
													"mouseenter .ui-menu-item" : function(
														...
														// from siblings of the
														// newly focused menu
														// item
														// to avoid a jump
														// caused by adjacent
														// elements both having
									...
									_keydown : function(event) {
										...
										default:
											...
											// If no matches on the current
											// filter, reset to the last
											// character pressed
											// to move down the menu to the
											// first item that starts with that
											// character
											if (!match.length) {
												character = String
														.fromCharCode(event.keyCode);
									...
									refresh : function() {
										...
										// Initialize menu-items containing
										...
										// Don't refresh list items that are
										// already adapted
										items
												.not(
									...
									focus : function(event, item) {
										...
										// Highlight active parent menu item, if
										// any
									...
									// it closes all menus. If passed an
									// argument, it will search for menus BELOW
									...
									select : function(event) {
										// TODO: It should never be possible to
										// not have an active item at this
				...
				$
						.widget(
								"ui.autocomplete",
								{
									...
									_create : function() {
										// Some browsers only repeat keydown
										// events, not keypress events,
										// so we use the suppressKeyPress flag
										// to determine if we've already
										// handled the keydown event. #7269
										// Unfortunately the code for & in
										// keypress is the same as the up arrow,
										// so we use the suppressKeyPressRepeat
										// flag to avoid handling keypress
										// events when we know the keydown event
										...
										isTextarea ? true :
										// Inputs are always single-line, even
										// if inside a contentEditable element
										// IE also treats inputs as
										// contentEditable
										isInput ? false :
										// All other element types are
										// determined by whether or not they're
										// contentEditable
										...
										// value when navigating through
										// history, so we re-enable autocomplete
										// if the page is unloaded before the
										// widget is destroyed. #7790
										this
												._on(
														this.window,
														{
									...
									search : function(value, event) {
										...
										// always save the actual value, not the
									...
									__response : function(content) {
										...
										if (!this.options.disabled && content
											...
											// use ._close() instead of .close()
											// so we don't cancel future
											// searches
											this._close();
										}
									},
									...
									_normalize : function(items) {
										// assume all items have the right
										// format when the first item is
										// complete
				...
				// a full solution for string manipulation and
