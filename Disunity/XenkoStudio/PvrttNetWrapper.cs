...
namespace SiliconStudio.TextureConverter.PvrttWrapper
{
    #region Enum
    ...
    internal enum EPVRTOrientation
    {
        ePVRTOrientLeft = 1 << EPVRTAxis.ePVRTAxisX,
        ePVRTOrientRight = 0,
        ePVRTOrientUp = 1 << EPVRTAxis.ePVRTAxisY,
        ePVRTOrientDown = 0,
        ePVRTOrientOut = 1 << EPVRTAxis.ePVRTAxisZ,
        ePVRTOrientIn = 0
    };
    #endregion
